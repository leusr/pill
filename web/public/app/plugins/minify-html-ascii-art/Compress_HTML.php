...
class Compress_HTML
{
	 ...
	 * @var boolean
	 */
	protected $useNewLines = true;

	/**
	 * Should content be treated as XHTML1.0?
	 *
	 * @var bool
	 */
	...
	/**
	 * Remove HTML comments beginning and end of SCRIPT block?
	 *
	 * @var boolean
	 */
	...
	/**
	 * Callback function to process content of SCRIPT elements.
	 *
	 * @var null|string
	 */
	...
	/**
	 * Callback function to process content of STLYE elements.
	 *
	 * @var null|string
	 */
	protected $cssMinifier = null;
	...
	public function process()
	{
		...
		$this->html = preg_replace_callback('/\\s*<pre(\\b[^>]*?>[\\s\\S]*?<\\/pre>)\\s*/i'
			, [$this, 'removePreCB']
			, $this->html);
